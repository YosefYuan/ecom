<template>
  <div class="sales-board">
    ...
    <create-order :is-show-check-dialog="isShowCheckDialog" :is-show-success-dialog="isShowSuccessDialog" :is-show-fail-dialog="isShowFailDialog" @pay-success="checkStatus" @pay-fail="checkStatus" @check-status="checkStatus"></create-order>
...
import createOrder from "@/components/base/createOrder";
export default {
  data() {
    return {
  ...
  methods: {
    ...
    confirmBuy() {
      ...
      this.$http.post("/api/createOrder", this.allPostParam).then(
        res => {
