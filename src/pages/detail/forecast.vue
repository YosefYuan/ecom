      ...
      <div class="sales-board-form">
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                  <counter :max="100" :min="20" @on-change="onParamChange('number',$event)"></counter>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
              ...
              <div class="sales-board-line-right">
                  <mutiply-chooser :selections="mediaList" @on-change="onParamChange('mediaTypeArr',$event)"></mutiply-chooser>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
...
export default {
  ...
  methods: {
    ...
    initParams() {
      this.mediaTypeArr = [this.mediaList[0]];
    },
    formatParams() {
      return {
        number: this.number,
        mediaType: this.mediaTypeArr.map(item => item.value).join()
      };
    },
    getPrice() {
